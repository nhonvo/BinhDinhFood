...
namespace BinhDinhFood.Unittest.Application.Services;
...
public class BookTest
{
    ...
    public async Task BookService_Get_ShouldReturnBooks()
    {
        ...
        _unitOfWorkMock
            .Setup(u => u.BookRepository.ToPagination(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<Expression<Func<Book, bool>>>(), It.IsAny<Func<IQueryable<Book>, IQueryable<Book>>>(), It.IsAny<Expression<Func<Book, object>>>(), It.IsAny<bool>()))
            .ReturnsAsync(expectedResult);
    ...
    public async Task BookService_Update_ShouldUpdateBook()
    {
        ...
        _unitOfWorkMock.Setup(u => u.BookRepository.FirstOrDefaultAsync(It.IsAny<Expression<Func<Book, bool>>>(), It.IsAny<Func<IQueryable<Book>, IQueryable<Book>>>()))
        ...
        // Assert
        _unitOfWorkMock.Verify(u => u.BookRepository.FirstOrDefaultAsync(It.IsAny<Expression<Func<Book, bool>>>(), It.IsAny<Func<IQueryable<Book>, IQueryable<Book>>>()), Times.Once);
