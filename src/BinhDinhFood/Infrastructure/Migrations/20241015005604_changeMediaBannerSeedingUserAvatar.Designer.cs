...
namespace BinhDinhFood.Infrastructure.Migrations
{
    ...
    [Migration("20241015005604_changeMediaBannerSeedingUserAvatar")]
    partial class changeMediaBannerSeedingUserAvatar
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BinhDinhFood.Domain.Entities.Auth.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("84c55fc3-0707-4141-86df-ab0c5f6c7aac"),
                            AccessFailedCount = 0,
                            Address = "Quy Nhơn, Bình Định",
                            AvatarId = 1,
                            ConcurrencyStamp = "38bf51b9-f7f5-474f-946e-9b079e306e35",
                            Email = "truongnhon@example.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            Name = "Võ Thương Trường Nhơn",
                            PasswordHash = "AQAAAAIAAYagAAAAEL4pognRAqjHdVpI1IujDPflGu2Rp1eNbO5VPQa5+g7zTx+qA8kt9zkruzXMdkNN8w==",
                            PhoneNumber = "0905726748",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "56d96616-843d-48d5-add6-bcfb8e6ee034",
                            Status = 0,
                        ...
                        new
                        {
                            Id = new Guid("9843c709-dad7-40d2-971b-8cb17d39db27"),
                            AccessFailedCount = 0,
                            Address = "Tây Ninh",
                            AvatarId = 2,
                            ConcurrencyStamp = "7ed989ae-0a9a-4564-a674-c7ce858db240",
                            Email = "hongthai@example.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            Name = "Nguyễn Hồng Thái",
                            PasswordHash = "AQAAAAIAAYagAAAAEC8gzU1/zGYfnOvzGictmdPpEHnjmDToNYXxaxDkODw/MPaza1R9zDBomuzdbwKXQA==",
                            PhoneNumber = "0905726748",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "5a897138-01f9-44ca-ab81-c91cacf6a584",
                            Status = 0,
                            TwoFactorEnabled = false,
                            UserName = "thai"
                        },
                        new
                        {
                            Id = new Guid("1161bc74-97f6-47fa-95bd-d1ba8ab59aa7"),
                            AccessFailedCount = 0,
                            Address = "Nam Định",
                            AvatarId = 3,
                            ConcurrencyStamp = "f3715555-8bf8-4161-b0ad-e5528d44cc22",
                            Email = "taiphamduc@example.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            Name = "Phạm Đức Tài",
                            PasswordHash = "AQAAAAIAAYagAAAAEO5G1eIbd6/YTfKCiDf9RcDXd1VYZo/cbPOBeRWoGjcL1uyiO6wF9f8LeD+QfCeZ4Q==",
                            PhoneNumber = "0905726748",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "ffa409a5-1814-4485-9a66-2303e1873d76",
                            Status = 0,
                            TwoFactorEnabled = false,
                            UserName = "tai"
                        },
                        new
                        {
                            Id = new Guid("a077bf63-f25a-49f8-b16a-95426ff86c1c"),
                            AccessFailedCount = 0,
                            Address = "Saigon",
                            ConcurrencyStamp = "21d82aa3-4630-4555-9dcd-53cad34eca31",
                            Email = "nhondeptrai@example.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            Name = "dotnet evil",
                            PasswordHash = "AQAAAAIAAYagAAAAEDjJUBVtnPwh5GiWaqrAbVMOIQw2fFBQMDIcenFaBZB4QPTV48WmzBsz6HQ39LTT9A==",
                            PhoneNumber = "0905726748",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "2ed57ade-6cce-4899-afc0-d01b694a0c24",
                            Status = 0,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            Id = new Guid("7fd027d4-bbc5-47a2-9243-3e5136eb7d65"),
                            AccessFailedCount = 0,
                            Address = "Admin City",
                            ConcurrencyStamp = "776c37c2-be04-44e7-8327-392fb170284d",
                            Email = "admin@example.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            Name = "Admin User",
                            PasswordHash = "AQAAAAIAAYagAAAAEK+ariBOQ+Y0shdXfTxBtBToHmBpun91AYzfh8znFQYuSPK2LnIoJF7/UTyZHCITNA==",
                            PhoneNumber = "123456789",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "ebe4a09e-4c4b-4af7-a21a-2e6fedccf127",
                            Status = 0,
                            TwoFactorEnabled = false,
                            UserName = "admin"
                        });
            ...
            modelBuilder.Entity("BinhDinhFood.Domain.Entities.Auth.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("7fd027d4-bbc5-47a2-9243-3e5136eb7d65"),
                            RoleId = new Guid("a3314be5-4c77-4fb6-82ad-302014682a73")
                        },
                        new
                        {
                            UserId = new Guid("84c55fc3-0707-4141-86df-ab0c5f6c7aac"),
                            RoleId = new Guid("b4314be5-4c77-4fb6-82ad-302014682b13")
                        },
                        new
                        {
                            UserId = new Guid("9843c709-dad7-40d2-971b-8cb17d39db27"),
                            RoleId = new Guid("b4314be5-4c77-4fb6-82ad-302014682b13")
                        },
                        new
                        {
                            UserId = new Guid("1161bc74-97f6-47fa-95bd-d1ba8ab59aa7"),
                            RoleId = new Guid("b4314be5-4c77-4fb6-82ad-302014682b13")
                        },
                        new
                        {
                            UserId = new Guid("a077bf63-f25a-49f8-b16a-95426ff86c1c"),
                            RoleId = new Guid("b4314be5-4c77-4fb6-82ad-302014682b13")
                        });
                });
            ...
            modelBuilder.Entity("BinhDinhFood.Domain.Entities.Media", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 10, 15, 7, 56, 4, 321, DateTimeKind.Local).AddTicks(8172),
                        ...
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 10, 15, 7, 56, 4, 321, DateTimeKind.Local).AddTicks(8197),
                        ...
                        {
                            Id = 4,
                            DateCreated = new DateTime(2024, 10, 15, 7, 56, 4, 513, DateTimeKind.Local).AddTicks(5397),
                        ...
                        {
                            Id = 5,
                            DateCreated = new DateTime(2024, 10, 15, 7, 56, 4, 513, DateTimeKind.Local).AddTicks(5407),
                            PathMedia = "slide_home_1.jpg",
                            Type = 1
                        },
                        new
                        {
                            Id = 6,
                            DateCreated = new DateTime(2024, 10, 15, 7, 56, 4, 513, DateTimeKind.Local).AddTicks(5408),
                            PathMedia = "slide_home_1.jpg",
                            Type = 1
                        },
                        new
