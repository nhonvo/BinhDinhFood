...
namespace BinhDinhFood.Infrastructure.Migrations
{
    ...
    [Migration("20241019191527_removeStatusUser")]
            ...
            modelBuilder.Entity("BinhDinhFood.Domain.Entities.Auth.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("05c34245-43a0-4c99-a406-51c5340b696f"),
                            AccessFailedCount = 0,
                            Address = "Quy Nhơn, Bình Định",
                            AvatarId = 1,
                            ConcurrencyStamp = "38c1f9e9-2537-4786-87c5-04d964697111",
                            Email = "truongnhon@example.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            Name = "Võ Thương Trường Nhơn",
                            PasswordHash = "AQAAAAIAAYagAAAAEMQ5QkeCwpWQeEEwWugB69uzFvAxYG+SknLlkK7n2jYVoKkYQUWyEkZoJRD2CnFkQQ==",
                            PhoneNumber = "0905726748",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "42286af1-2d96-4a8d-a7b5-0ae66a7960bd",
                            TwoFactorEnabled = false,
                            UserName = "truongnhon"
                        },
                        new
                        {
                            Id = new Guid("031e8695-e2d1-4730-a9bf-febde2f02cad"),
                            AccessFailedCount = 0,
                            Address = "Tây Ninh",
                            AvatarId = 2,
                            ConcurrencyStamp = "76ec2799-96ca-4b3a-aeb1-dfb1fc4886ff",
                            Email = "hongthai@example.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            Name = "Nguyễn Hồng Thái",
                            PasswordHash = "AQAAAAIAAYagAAAAEH02LXsa4MDcluji15shTV0dRL8Te3Mf1xE2Jfx9IOeZwxWlppismfahBfUDmTkXNA==",
                            PhoneNumber = "0905726748",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "7af1a18c-ffba-4b61-a130-263bb0cdbb37",
                            TwoFactorEnabled = false,
                            UserName = "thai"
                        },
                        new
                        {
                            Id = new Guid("4fef3895-9d0b-4c2f-a9ca-e17f4d3fddb1"),
                            AccessFailedCount = 0,
                            Address = "Nam Định",
                            AvatarId = 3,
                            ConcurrencyStamp = "ce43e066-35ff-444b-9f7c-aa32351669f7",
                            Email = "taiphamduc@example.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            Name = "Phạm Đức Tài",
                            PasswordHash = "AQAAAAIAAYagAAAAEJxlnGzVQgIcelpC/YFsjvvLYPqeOZkZcjhvY3uUZXe1ETo1YE2Di/1/HrMLemUkWQ==",
                            PhoneNumber = "0905726748",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "938d0212-a2dd-4f62-9b9a-dbfc75158c02",
                            TwoFactorEnabled = false,
                            UserName = "tai"
                        },
                        new
                        {
                            Id = new Guid("dda27303-c0a1-4991-856b-5810686f7973"),
                            AccessFailedCount = 0,
                            Address = "Saigon",
                            ConcurrencyStamp = "aa007ac4-cddf-4daf-84f1-de4a698fafc2",
                            Email = "nhondeptrai@example.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            Name = "dotnet evil",
                            PasswordHash = "AQAAAAIAAYagAAAAEFtSW/xy3+OX0fiPbaphN8LjB3a8425/JEMqR31DAJl62UGyCKVbwKRjgubhDlBTUw==",
                            PhoneNumber = "0905726748",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "80f9ff7e-5e89-49f7-b887-ead5e75c4e31",
                            TwoFactorEnabled = false,
                            UserName = "nhondeptrai"
                        },
                        new
                        {
                            Id = new Guid("9252e5d5-328f-470a-9862-5d220595a574"),
                            AccessFailedCount = 0,
                            Address = "Admin City",
                            ConcurrencyStamp = "ee154120-cc6d-43ec-9eec-18470215fff7",
                            Email = "admin@example.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            Name = "Admin User",
                            PasswordHash = "AQAAAAIAAYagAAAAEHHbB8NPYcbRFAngFGG2d0Er+bxcFnfzA7CkzjXy5YMQhkuwjK0wv4T9ZAt1kyZgsw==",
                            PhoneNumber = "123456789",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "99aa37e9-e2c7-420c-8f84-221ace747a6f",
                            TwoFactorEnabled = false,
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("BinhDinhFood.Domain.Entities.Auth.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("9252e5d5-328f-470a-9862-5d220595a574"),
                            RoleId = new Guid("a3314be5-4c77-4fb6-82ad-302014682a73")
                        },
                        new
                        {
                            UserId = new Guid("05c34245-43a0-4c99-a406-51c5340b696f"),
                            RoleId = new Guid("b4314be5-4c77-4fb6-82ad-302014682b13")
                        },
                        new
                        {
                            UserId = new Guid("031e8695-e2d1-4730-a9bf-febde2f02cad"),
                            RoleId = new Guid("b4314be5-4c77-4fb6-82ad-302014682b13")
                        },
                        new
                        {
                            UserId = new Guid("4fef3895-9d0b-4c2f-a9ca-e17f4d3fddb1"),
                            RoleId = new Guid("b4314be5-4c77-4fb6-82ad-302014682b13")
                        },
                        new
                        {
                            UserId = new Guid("dda27303-c0a1-4991-856b-5810686f7973"),
                            RoleId = new Guid("b4314be5-4c77-4fb6-82ad-302014682b13")
                        });
                });
            ...
            modelBuilder.Entity("BinhDinhFood.Domain.Entities.Media", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 10, 20, 2, 15, 26, 67, DateTimeKind.Local).AddTicks(4742),
                        ...
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 10, 20, 2, 15, 26, 67, DateTimeKind.Local).AddTicks(4767),
                        ...
                        {
                            Id = 3,
                            DateCreated = new DateTime(2024, 10, 20, 2, 15, 26, 67, DateTimeKind.Local).AddTicks(4768),
                        ...
                        {
                            Id = 4,
                            DateCreated = new DateTime(2024, 10, 20, 2, 15, 26, 267, DateTimeKind.Local).AddTicks(6907),
                        ...
                        {
                            Id = 5,
                            DateCreated = new DateTime(2024, 10, 20, 2, 15, 26, 267, DateTimeKind.Local).AddTicks(6913),
                            PathMedia = "slide_home_1.jpg",
                            Type = 1
                        },
                        new
                        {
                            Id = 6,
                            DateCreated = new DateTime(2024, 10, 20, 2, 15, 26, 267, DateTimeKind.Local).AddTicks(6914),
                            PathMedia = "slide_home_1.jpg",
                            Type = 1
                        },
                        new
                        {
                            Id = 7,
                            DateCreated = new DateTime(2024, 10, 20, 2, 15, 26, 267, DateTimeKind.Local).AddTicks(6915),
                            PathMedia = "slide_home_1.jpg",
                            Type = 1
                        });
                });
