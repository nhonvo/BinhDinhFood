    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("27f607d9-071c-41ac-9281-6680bf999b6f"), 0, "Tây Ninh", "0df35a38-f467-4a91-ac0e-974ab3d14442", "hongthai@example.com", false, 52, false, null, "Nguyễn Hồng Thái", null, null, "AQAAAAIAAYagAAAAEDaM4TH3gj31u5VLvaS8cXpCcXx82rm0itbh+B4SYxulL/nuNIXwUU3pS1+JXGAJvw==", "0905726748", false, "b5af51e4-da96-48ed-8c31-ad8e70102d61", false, "thai" },
                    { new Guid("557d149f-3dc3-4aee-a28d-ad98cd693c71"), 0, "Saigon", "d06dc1f6-0d2c-469d-8de1-23fdc4cdb72c", "nhondeptrai@example.com", false, null, false, null, "dotnet evil", null, null, "AQAAAAIAAYagAAAAEBpZv+EnqOTI+KQsgM3ZZpFo5Bge4MG88D6wfloVI0fuL8+nCcpxmibcr3ZbzFsP7Q==", "0905726748", false, "0860fddb-2559-4c2f-9e45-f5469b86772d", false, "nhondeptrai" },
                    { new Guid("ba4c9391-0d48-4bbd-84ac-f447c6a208e1"), 0, "Quy Nhơn, Bình Định", "0efae8b0-436e-4c7f-b2b6-4cb3d6106aa1", "truongnhon@example.com", false, 51, false, null, "Võ Thương Trường Nhơn", null, null, "AQAAAAIAAYagAAAAEEFGaqfMV+XjucENh2P/Cv11ujz4nQqcMdxZIl1oguFvlm5h+wQpw0Da9m8R8y2jPQ==", "0905726748", false, "3375812f-bbc3-44a3-978f-ccffe382d432", false, "truongnhon" },
                    { new Guid("e48b971b-c5b1-49b3-a280-a121d3ee3fa5"), 0, "Admin City", "6e2e9d02-6b90-4655-a1b9-1c21d2462c3a", "admin@example.com", false, null, false, null, "Admin User", null, null, "AQAAAAIAAYagAAAAENs9iYeh9y6WM24GVEudW5pYRvnPml7IPeE/+Em1tNN0okwJ+QWG/UTs9WjQaopVIA==", "123456789", false, "9e3648d1-3d4f-42b5-9987-f1ce2387f242", false, "admin" },
                    { new Guid("ee71bc9b-3def-4f94-aaf4-d09b2e7d11ab"), 0, "Nam Định", "d348779c-9145-42b9-95e8-be03a62a1e70", "taiphamduc@example.com", false, 53, false, null, "Phạm Đức Tài", null, null, "AQAAAAIAAYagAAAAELvuQzwDdLVmKpxYo+wtTqSCxZrKMV9FmMYBcNqcVphpaNDw5Jm8zQFiyueOzb2Q5Q==", "0905726748", false, "a11c1b46-69fa-4635-af77-4caddb15e1d5", false, "tai" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "Id", "DateCreated", "DateUpdated", "Description", "Name", "OffPrice", "Price", "Quality", "Rating" },
                values: new object[,]
                {
                    ...
                    { 4, new DateTime(2022, 8, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "cá cơm giàu vitamin A, nhiều axit béo, vitamin E, canxi, Vitamin A, giúp mắt sáng, ngăn ngừa các bệnh về mắt, duy trì làn da khỏe mạnh. Ăn cá cơm giúp giảm lượng cholesterol trong máu, ngăn ngừa các bệnh về tim mạch.\nCá cơm cung cấp một lượng lớn protein và đạm, nên chúng được sử dụng để làm nước mắm nhĩ", "Cá cơm khô", 15, 18000m, 55, 0 },
            ...
            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "Id", "DateCreated", "DateUpdated", "Description", "Name", "Price", "Quality", "Rating" },
                values: new object[,]
                {
                    ...
                    { 17, new DateTime(2022, 9, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Bánh hồng Tam Quan là một trong những món đặc sản của Bình Định, được xem như biểu trưng cho tin vui, thường xuất hiện trong các dịp cưới hỏi của người dân nơi đây.\n Điều đặc biệt bánh hồng Tam Quan là bánh được làm từ gạo nếp Ngự nổi tiếng dẻo thơm. Do hoàn toàn không có chất bảo quản nên bánh chỉ để được 5 ngày thôi bạn nhé.", "Bánh hồng Tam Quan", 200000m, 50, 0 },
                    { 18, new DateTime(2022, 9, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Bánh tráng chả cá là một trong những đặc sản nổi tiếng gần xa của Bình Định. Bánh tráng chả cá được làm từ nguyên liệu chính là cá cùng một ít gia vị và bột năng. Để món ăn đúng vị hơn bạn nên ăn kèm với rau răm nhé.", "Bánh tráng chả cá", 400000m, 50, 0 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 24, new DateTime(2022, 9, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Chả Bò (Giò Bò) Bình Định Chính Gốc – Cây 500G", "Chả Bò (Giò Bò) Bình Định Chính Gốc – Cây 500G", 180000m, 15, 0 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("b4314be5-4c77-4fb6-82ad-302014682b13"), new Guid("27f607d9-071c-41ac-9281-6680bf999b6f") },
                    { new Guid("b4314be5-4c77-4fb6-82ad-302014682b13"), new Guid("557d149f-3dc3-4aee-a28d-ad98cd693c71") },
                    { new Guid("b4314be5-4c77-4fb6-82ad-302014682b13"), new Guid("ba4c9391-0d48-4bbd-84ac-f447c6a208e1") },
                    { new Guid("a3314be5-4c77-4fb6-82ad-302014682a73"), new Guid("e48b971b-c5b1-49b3-a280-a121d3ee3fa5") },
                    { new Guid("b4314be5-4c77-4fb6-82ad-302014682b13"), new Guid("ee71bc9b-3def-4f94-aaf4-d09b2e7d11ab") }
                });
